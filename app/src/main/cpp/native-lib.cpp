...
{
    gscSetInputs(0, (double)i_W, (double)i_w, (double)i_R, (double)i_A_tsa, (double)i_S, (double)i_k, (double)i_u, (double)i_o, (double)i_y1, (double)i_y2, (double)i_y3);
    return;
}
...
Java_gurik_andrew_testapp0_MainActivity_gscCalcJNI(JNIEnv *env, jobject /* this */)
{
    ...
    std::string hello = std::to_string(gscCalculate(0));
